...
class ProductoResourceIT {
    ...
    public static Producto createEntity(EntityManager em) {
        return new Producto().cod(DEFAULT_COD).name(DEFAULT_NAME).price(DEFAULT_PRICE).stock(DEFAULT_STOCK);
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        return new Producto().cod(UPDATED_COD).name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
    }
    ...
    void createProducto() throws Exception {
        ...
        assertThat(testProducto.getCod()).isEqualTo(DEFAULT_COD);
    ...
    void putNewProducto() throws Exception {
        ...
        updatedProducto.cod(UPDATED_COD).name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
        ...
        Producto testProducto = productoList.get(productoList.size() - 1);
        assertThat(testProducto.getCod()).isEqualTo(UPDATED_COD);
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.cod(UPDATED_COD).name(UPDATED_NAME);
    ...
    void fullUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.cod(UPDATED_COD).name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
